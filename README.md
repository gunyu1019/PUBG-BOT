...
> 해당 프로젝트에 대한 `개인 메시지(DM)`을 통하여 문의하는 것을 일체 금지합니다.<br/>
> 추후 안내사항이 있을 때 까지 Github의 [Issues](https://github.com/gunyu1019/PUBG-BOT/issues) 혹은 [포럼 서버](https://yhs.kr/PUBG_BOT/forum.html) 만을 이용해주시기 부탁드립니다.
